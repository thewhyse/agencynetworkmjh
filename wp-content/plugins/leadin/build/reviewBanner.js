...
function initMonitorReviewBanner() {
  ...
  if (!window.reviewBannerTracking) {
    ...
    window.reviewBannerTracking = {
      monitorReviewBannerRendered: _api_hubspotPluginApi__WEBPACK_IMPORTED_MODULE_2__.monitorReviewBannerRendered,
      monitorReviewBannerLinkClicked: _api_hubspotPluginApi__WEBPACK_IMPORTED_MODULE_2__.monitorReviewBannerLinkClicked,
      monitorReviewBannerDismissed: _api_hubspotPluginApi__WEBPACK_IMPORTED_MODULE_2__.monitorReviewBannerDismissed
    };
  }

  function reviewLinkClickHandler() {
    var reviewBanner = document.getElementById('leadin-review-banner');

    if (reviewBanner) {
      reviewBanner.classList.add('leadin-review-banner--hide'); //@ts-expect-error global
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(_constants_selectors__WEBPACK_IMPORTED_MODULE_3__.domElements.reviewBannerLeaveReviewLink).off('click').on('click', reviewLinkClickHandler);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(_constants_selectors__WEBPACK_IMPORTED_MODULE_3__.domElements.reviewBannerDismissButton).off('click').on('click', dismissBtnClickHandler);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#leadin-iframe').ready(function () {
    (0,_api_hubspotPluginApi__WEBPACK_IMPORTED_MODULE_2__.monitorReviewBannerRendered)();
  });
}

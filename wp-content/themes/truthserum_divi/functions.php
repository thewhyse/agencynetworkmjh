...
// smacss
function wploco_assets() {
	wp_register_style( 'wploco-stylesheet', get_theme_file_uri() . '/dist/css/bundle.css', array(), '1.0.0', 'all' );
	wp_enqueue_style('wploco-stylesheet');
	wp_enqueue_script('wploco_js', get_theme_file_uri() . '/dist/js/bundle.js', array('jquery'), '1.0.0', true);
}
add_action('wp_enqueue_scripts', 'wploco_assets');
